...
creditsPage <- tabPanel("About",
                        ...
                        tags$div(class="bodyTextContainer",
                                 ...
                                 tags$p(a(href='https://www.census.gov/programs-surveys/acs', '2009 ACS 5-year estimates'), 'via the R package', a(href='https://walker-data.com/tidycensus/', 'tidycensus')),
